...
const SideBar = ({ isOpen, toggleSideBar }) => {
  ...
  return (
    <div
      className={`text-white fixed inset-0 bg-gray-800 p-2 transition-transform
            transform md:relative md:translate-x-0 md:w-1/4 md:block
            ${isOpen ? "translate-x-0" : "-translate-x-full"}`}
    >
      <div className="text-2xl font-semibold mb-6">Assistify</div>
      <div className="mb-4">
        <button
          onClick={createChat}
      ...
      <div className="absolute bottom-0 mb-6 w-full">
        <button
          className="px-2 py-2 bg-black hover:bg-gray-500 hover:text-black rounded text-xl
